  ...
  return (
    <div className="settings-container">
      ...
      <motion.button
        ...
        className="bg-gradient-to-r from-[#1a1a2e]/90 to-[#2a2a4e]/90 backdrop-blur-sm text-white p-2 sm:p-3 rounded-xl sm:rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-white/20 hover:border-white/40 settings-button"
